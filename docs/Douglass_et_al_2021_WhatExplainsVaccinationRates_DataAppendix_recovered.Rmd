...
rhs_codebook <- rhs_combined %>% 
                 ...
                 sdf_distinct() %>% #don't do regular distinct or it'll take crazy long
                  ...
                  mutate(category_race = dataset  %rlike%  "census_2020_actual|census2020|acs5" & variable  %rlike%  "race|black|indian|hispanic|white|ancestry|asian|hawaiian|language|pop_aian|vap_hisp|vap_two|vap_other|vap_aian|pop_two_|pop_nhpi|pop_hisp|pop_other") %>%
                  ...
                  mutate(category_wealth_employment = dataset  %rlike%  "census_2020_actual|census2020|acs5" &  variable  %rlike%  "poverty|income|earnings|food_stamps|labor_force|employment|earner|owner_costs") %>%
                  ...
                  mutate(category_health_conditions = dataset  %rlike%  "countyhealthrankings"  & variable  %rlike% "obesity|smoking|birthweight|fair_health|low_birthweight|hospital_stays" ) %>%
                  ...
                  mutate(category_religion = dataset  %rlike%  "therda") %>%
